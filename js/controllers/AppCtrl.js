(function (window) {
    ...
    module.controller('AppCtrl', ['AuthService', '$ionicModal', '$ionicSideMenuDelegate', '$ionicPopup', '$scope', '$state', '$cordovaNetwork', '$cordovaToast', function (AuthService, $ionicModal, $ionicSideMenuDelegate, $ionicPopup, $scope, $state, $cordovaNetwork, $cordovaToast) {
