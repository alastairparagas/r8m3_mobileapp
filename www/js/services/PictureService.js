(function (window) {
    ...
    angular.module('rateMeApp.services').service('PictureService', ['AuthService', '$q', '$state', '$cordovaNetwork', '$cordovaToast', '$cordovaFile', '$cordovaCamera', '$cordovaDialogs', function (AuthService, $q, $state, $cordovaNetwork, $cordovaToast, $cordovaFile, $cordovaCamera, $cordovaDialogs) {
        ...
        this.takePicture = function () {
            ...
            if (AuthService.getSetting("smartUpload")) {
                if ($cordovaNetwork.getNetwork() === window.Connection.ETHERNET || $cordovaNetwork.getNetwork() === window.Connection.Wifi) {
                    options.quality = 100;
                } else {
                    options.quality = 70;
                }
